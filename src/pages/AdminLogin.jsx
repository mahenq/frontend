      ...
      <div className="page-content">
        ...
        <div className="content-wrapper">
          ...
          <div className="adminlogin-container">
            <div className="title adminlogin-title">Admin Login</div>

            <div className="subtitle adminlogin-subtitle">
              Access the admin dashboard to manage your content, projects, and
              site settings. Please enter your credentials to continue.
            </div>
